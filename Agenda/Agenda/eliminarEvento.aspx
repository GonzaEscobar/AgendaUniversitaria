...
<body background=  "fondo2.jpg">
    ...
    <div style="color: #FFFFFF">
     ...
     <asp:Menu ID="Menu1" runat="server" BackColor="#F0F0F0" ForeColor="#00CCFF" 
        ...
        <Items>
            ...
            <asp:MenuItem NavigateUrl="~/agregarEvento.aspx" Text="Agregar Evento" 
                Value="Agregar Evento"></asp:MenuItem>
        </Items>
    </asp:Menu>
        </a>  
            <br />
    ...
    <div class= "caja">
        ...
        <br />
        <center><asp:Button ID="Eliminar" runat="server" Text="Eliminar" /></center>
        <br />
        <br />
        <center><span class="style1"> <asp:Label ID="lblRespuesta" runat="server" ForeColor="Red"></asp:Label>
            </span></center>
        <br />
    </div>
    </form>
